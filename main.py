...
# Weights in kg.
Weight = st.number_input("Enter your value of Weight: ",value=0.00)

# Height in meter square.
Height = st.number_input("Enter your value of Height: ",value=0.00)

# MUAC in Centi Meter
MUAC=st.number_input("Enter your value of Muac: ",value=0.00)
